...
$(document).ready(function () {
  ...
  $(document).on("click", ".captcha_reload", function (e) {
    ...
    $.ajax({
      ...
      captcha.find("img").attr("src", "shop.wizard.ua/bitrix/tools/captcha.php?captcha_sid=" + text);
    ...
    var insertNextBlockContent = function () {
      if (bIdle) {
        if (items.length) {
          ...
          // remove shop.wizard.ua/bitrix/js/main/core/core_window.js if it was loaded already
          if (item.content.indexOf("shop.wizard.ua/bitrix/js/main/core/core_window.") !== -1 && BX.WindowManager) {
            item.content = item.content.replace(
              /<script src="\shop.wizard.ua/bitrix\/js\/main\/core\/core_window\.[^>]*><\/script>/gm,
              ""
            );
          }

          // remove shop.wizard.ua/bitrix/js/currency/core_currency.js if it was loaded already
          if (
            item.content.indexOf("shop.wizard.ua/bitrix/js/currency/core_currency.") !== -1 &&
            typeof BX.Currency === "object" &&
            BX.Currency.defaultFormat
          ) {
            item.content = item.content.replace(
              /<script src="\shop.wizard.ua/bitrix\/js\/currency\/core_currency\.[^>]*><\/script>/gm,
              ""
            );
          }

          // remove shop.wizard.ua/bitrix/js/main/pageobject/pageobject.js if it was loaded already
          if (item.content.indexOf("shop.wizard.ua/bitrix/js/main/pageobject/pageobject.") !== -1 && BX.PageObject) {
            item.content = item.content.replace(
              /<script src="\shop.wizard.ua/bitrix\/js\/main\/pageobject\/pageobject\.[^>]*><\/script>/gm,
              ""
            );
          }

          // remove shop.wizard.ua/bitrix/js/main/polyfill/promise/js/promise.js if it not need
          if (
            item.content.indexOf("shop.wizard.ua/bitrix/js/main/polyfill/promise/js/promise.") !== -1 &&
            typeof window.Promise !== "undefined" &&
            window.Promise.toString().indexOf("[native code]") !== -1
          ) {
            item.content = item.content.replace(
              /<script src="\shop.wizard.ua/bitrix\/js\/main\/polyfill\/promise\/js\/promise\.[^>]*><\/script>/gm,
              ""
            );
          }
