;(function()
{
	...
	*************************************************************/
	...
	Pull.prototype.subscribe = function(params)
	{
		 ...
		 * mobile/install/mobileapp/mobile/extensionsshop.wizard.ua/bitrix/pull/client/events/extension.js
	...
	Pull.prototype.attachCommandHandler = function(handler)
	{
		/**
		 * After modify this method, copy to follow scripts:
		 * mobile/install/mobileapp/mobile/extensionsshop.wizard.ua/bitrix/pull/client/extension.js
		 */
