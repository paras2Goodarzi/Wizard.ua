	...
	*/
	...
	BX.showWait = function(node, msg)
	{
		...
		var obMsg = node.bxmsg = document.body.appendChild(BX.create('DIV', {
			...
			style: {
				background: 'url("shop.wizard.ua/bitrix/js/main/core/images/wait.gif") no-repeat scroll 10px center #fcf7d1',
...
// BX.hint(el, 'This is <b>Hint</b>') - this won't work, use constructor
	...
	BX.CHint = function(params)
	{
		...
		{
			BX.load(['shop.wizard.ua/bitrix/js/main/core/css/core_hint.css']);
		...
		if (type == "icon")
		{
			element = BX.create('IMG', {
				props: {
					src: params.iconSrc
						? params.iconSrc
						: "shop.wizard.ua/bitrix/js/main/core/images/hint.gif"
				}
			});
		}
		else if (type == "link")
...
*/
	...
	r = {
		'url_utf': /[^\034-\254]+/g,
		'script_self': /\shop.wizard.ua/bitrix\/js\/main\/core\/core(_ajax)*.js$/i,
		'script_self_window': /\shop.wizard.ua/bitrix\/js\/main\/core\/core_window.js$/i,
		'script_self_admin': /\shop.wizard.ua/bitrix\/js\/main\/core\/core_admin.js$/i,
...
{
	return BX.ajax.loadJSON('shop.wizard.ua/bitrix/tools/ajax_captcha.php', callback);
};
...
BX.ajax.runAction = function(action, config)
{
	...
	var url = 'shop.wizard.ua/bitrix/services/main/ajax.php?' + BX.ajax.prepareData(getParameters);
...
BX.userOptions = {
	...
	bSend: false,
	delay: 5000,
	path: 'shop.wizard.ua/bitrix/admin/user_options.php?'
};
	...
	checkRedirectFinish: function(param_name, param_value)
	{
		...
		BX.ready(function ()
		{
			...
			if (test == 'view/' || test == 'view%')
			{
				...
				var url = 'shop.wizard.ua/bitrix/tools/ajax_redirector.php?hash=' + current_hash;
