...
var jsAjaxUtil = {
	...
	{
		if (
			/\shop.wizard.ua/bitrix\/js\/main\/ajax.js$/i.test(script_src)
			||
			/\shop.wizard.ua/bitrix\/js\/main\/core\/core.js$/i.test(script_src)
		) return;
	...
	checkRedirectFinish: function(param_name, param_value)
	{
		...
		jsEvent.addEvent(window, 'load', function () 
		{
			...
			if (current_hash.substring(0, 5) == 'view/')
			{
				...
				var url = 'shop.wizard.ua/bitrix/tools/ajax_redirector.php?hash=' + current_hash; //jsAjaxHistory.urlencode(current_hash);
